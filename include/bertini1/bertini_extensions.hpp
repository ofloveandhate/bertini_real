...
enum {NULLSPACE = 3000, LINPRODTODETJAC, DETJACTODETJAC, LINTOLIN, MULTILIN, MIDPOINT_SOLVER, SPHERE_SOLVER, BERTINI_MAIN, SAMPLE_CURVE, SAMPLE_SURFACE, TRACKER_CONFIG};

enum {TERMINATE = 2000, INITIAL_STATE};



enum {VEC_MP = 4000, VEC_D, MAT_MP, MAT_D, COMP_MP, COMP_D, VEC_RAT, MAT_RAT, COMP_RAT, INDICES, DECOMPOSITION, CURVE, SURFACE, EDGE, CELL, FACE, UNUSED, VERTEX_SET, WITNESS_SET, VERTEX, SYSTEM_RANDOMIZER, SOLUTION_METADATA};
