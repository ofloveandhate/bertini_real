...
These instructions were last updated in 2016.  They need updating.  Version numbers are almost certainly incorrect.



Unlike Linux or Mac computers, Windows users have additional pre-requisites that they need to install in order to use Bertini and Bertini\_real --- they need to first install the program Cygwin.\footnote{These Windows install instructions prepared by Beth Sudkamp.  Thanks Beth!}  Or, maybe MinGW. 
...
\textbf{Instructions} & \textbf{Screen Shot} \\ \hline
Click `next' on the first screen. & \includegraphics[width=0.4\textwidth]{CygwinInstall1}  \\ \hline
Select the `Install from Internet' option; click `next'. & \includegraphics[width=0.4\textwidth]{CygwinInstall2}  \\ \hline
Enter the preferred installation directory; click `next'. & \includegraphics[width=0.4\textwidth]{CygwinInstall3}  \\ \hline
Choose a temporary installation folder; click `next'. & \includegraphics[width=0.4\textwidth]{CygwinInstall4}  \\ \hline
Select the `Direct Connection' option; click `next'. & \includegraphics[width=0.4\textwidth]{CygwinInstall5}  \\ \hline
Choose a download site; click `next'. & \includegraphics[width=0.4\textwidth]{CygwinInstall6} \\ \hline
Select the packages that you will need. , then click `next'. See below for more instructions & \includegraphics[width=0.4\textwidth]{CygwinInstall7}  \\ \hline
