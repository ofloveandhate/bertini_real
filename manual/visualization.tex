...
\begin{longtblr}
{
    colspec={X[1,l]X[1,r]X[1,c]X[3,c]X[2,r]},
    caption={MATLAB Visualization Options}
}   
\textbf{Option} & \textbf{Default} & \textbf{Alter} & \textbf{Command Line} & \textbf{Description} \\ \hline 
% \endfirsthead
% \caption[]{\textit{Continued from previous page}} \\ \hline
% \textbf{Option} & \textbf{Default} &  \textbf{Alter} & \textbf{Command Line} & \textbf{Description} \\ \hline
% \endhead
...
First, move to \verb|bertini_real/python| and \verb|pip install .| 

Much fuller documentation for this is \href{https://doc.bertinireal.com/python}{online on bertinireal.com}.
