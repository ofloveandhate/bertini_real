...
{
    public class PlugNegative : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the NegativePlugComponent class.
        /// </summary>
        public PlugNegative()
          : base("Plug Negative", "PlugNeg",
              "Use as a negative to create holes to remove from the piece and positive plug to allow threading a wire",
        ...
        /// </summary>
        protected override System.Drawing.Bitmap Icon => IconLoader.GetIcon("plug_negative.png");
