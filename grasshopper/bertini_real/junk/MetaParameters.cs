...
{
    public class MetaParameter : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the MetaParameter class.
        /// </summary>
        public MetaParameter()
          : base("Add Parameters", "Params",
              "Work in progress.  Makes a bunch of parameters show up on the canvas",
              "bertini_real", "Junk")
        {
        }
