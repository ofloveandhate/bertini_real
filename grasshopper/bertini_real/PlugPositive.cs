...
{
    public class PlugPositive : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the PositivePlugComponent class.
        /// </summary>
        public PlugPositive()
          : base("Plug Positive", "PlugPos",
              "Make a positive part for a plug assembly",
        ...
        /// </summary>
        protected override System.Drawing.Bitmap Icon =>  IconLoader.GetIcon("plug_positive.png");
