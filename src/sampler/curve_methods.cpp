									  ...
									  std::vector<int> const& num_samples_per_interval)
{
	...
	//seed the workers              -straight from fixed-
	for (int ii=1; ii<solve_options.num_procs(); ii++) {
		...
		//change amount to be num_samples_per_interval.size()?
	}

	// send workers target_num_samples? this case we have num_samples_per_interval
